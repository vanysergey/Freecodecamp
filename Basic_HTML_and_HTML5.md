...
<main>
  ...
  <form action="https://www.freecatphotoapp.com/submit-cat-photo">
   ...
   <label for="check1"><input id="check1" type="checkbox" name="personality">checkbox 1</label>
   <label for="check2"><input id="check2" type="checkbox" name="personality">checkbox 2</label>
   <label for="check3"><input id="check3" type="checkbox" name="personality">checkbox 3</label>
    <input type="text" placeholder="cat photo URL" required>
    <button type="submit">Submit</button>
  </form>
</main>
...
<main>
  ...
  <form action="https://www.freecatphotoapp.com/submit-cat-photo">
    <label for="indoor"><input  type="radio" name="indoor-outdoor" value="indoor"  checked> Indoor</label>
